            ...
            <div className="space-y-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="space-y-2">
                  {(selectedDisplacementForModal as any).bienes_nombres && (selectedDisplacementForModal as any).valor_total != null ? (
                    <>
                      ...
                      <div className="flex justify-between items-center p-3 bg-primary/10 border border-primary/20 rounded-lg mt-3">
                        ...
                        <span className="text-lg font-bold text-primary">
                          ${(selectedDisplacementForModal as any).valor_total.toFixed(2)}
                        </span>
                      </div>
                    </>
                  ) : (
