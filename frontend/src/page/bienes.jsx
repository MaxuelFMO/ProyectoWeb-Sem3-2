                ...
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-[#111827]/95 border border-white/10 rounded-3xl p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleImportExcel} className="space-y-6">
                            ...
                            {importResult && (
                                <div className={`p-4 rounded-2xl border ${importResult.type === "success"
                                        ? "bg-emerald-500/10 border-emerald-500/30"
                                        : "bg-orange-500/10 border-orange-500/30"
                                    }`}>
                                    <div className="flex items-start gap-3">
                                        <i className={`bi text-xl mt-0.5 ${importResult.type === "success" ? "bi-check-circle text-emerald-400" : "bi-exclamation-triangle text-orange-400"
                                            }`} />
                                        <div>
