...
CREATE TABLE
    IF NOT EXISTS HistorialMovimientos (
        ...
        CONSTRAINT fk_historial_persona FOREIGN KEY (id_persona) REFERENCES personas (id_persona) ON UPDATE CASCADE ON DELETE CASCADE,
